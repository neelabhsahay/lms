                            ...
                            <div class="p-3 py-5">
                                ...
                                <div class="row mt-6">
                                    <div class="col-md-6">
                                        ...
                                        <input id="alStartDate" name='startDate' type="date" class="form-control" readonly="true">
                                    </div>
                                    <div class="col-md-6">
                                        <label class="labels">End Date</label>
                                        <input id="alStartDate"  name='endDate' type="date" class="form-control" readonly="true">
                                    </div>
                                </div>
                                <div class="row mt-6">
                                    <div class="col-md-12">
                                        <label class="labels">Approver</label>
                                        <input name="approver" type="text" class="form-control" readonly="true" value=""    >
                                    </div>
                                </div>
                            </div>
                            <div class="p-3 py-5">
                                <div class="row mt-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select name='leaveId' class="form-control" placeholder="Select Leave Type">
                                        </select>
                                    </div>
                                </div>
                                <div class="row mt-6">
