  ...
  <div class="col-md-8">
   ...
   <div class="row mt-6">
    ...
    <div class="col-md-6">
       ...
       <input id="alEndDate"  name='endDate' type="date" class="form-control" readonly="true">
    </div>
 </div>
 <div class="row mt-6">
...
<div class="row mt-6">
   <div class="col-md-12">
    ...
    <input name="notifier" type="text" class="form-control" placeholder="Notifier list" readonly="true">
 </div>
</div>
</div>
